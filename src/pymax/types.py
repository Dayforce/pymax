...
class Stats:
    def __init__(self, views: int | None = None) -> None:
        """
        Статистика сообщения (просмотры).
        """
        self.views = views

    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> Self:
        return cls(views=data.get("views"))

    @override
    def __repr__(self) -> str:
        return f"Stats(views={self.views!r})"
...
class Button:
    ...
    @override
    def __repr__(self) -> str:
        return f"Button(text={self.text!r}, type={self.type!r}, url={self.url!r})"
...
class Keyboard:
    ...
    def from_dict(cls, data: dict[str, Any]) -> Self:
        ...
        for row in data.get("buttons", []):
            buttons.append([Button.from_dict(b) for b in row])
        return cls(buttons=buttons)


class InlineKeyboardAttach:
    def __init__(
        self,
        keyboard: Keyboard,
        callback_id: str | None = None,
        type: AttachType = AttachType.INLINE_KEYBOARD,
    ) -> None:
    ...
    def from_dict(cls, data: dict[str, Any]) -> Self:
        return cls(
            keyboard=Keyboard.from_dict(data.get("keyboard", {})),
    ...
    @override
    def __repr__(self) -> str:
        return f"InlineKeyboardAttach(callback_id={self.callback_id!r}, keyboard={self.keyboard!r})"
...
class Message:
    ...
    def from_dict(cls, data: dict[Any, Any]) -> Self:
        ...
        for a in message.get("attaches", []):
            ...
            elif a["_type"] == AttachType.INLINE_KEYBOARD:
                attaches.append(InlineKeyboardAttach.from_dict(a))
